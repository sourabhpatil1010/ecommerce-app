...
export function PaymentSuccessPage() {
  ...
  return (
    <div className="container-app py-16 max-w-2xl flex flex-col items-center">
      ...
      <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-3xl p-8 sm:p-10 shadow-xl w-full text-center space-y-6 relative overflow-hidden">
        ...
        {loading ? (
          ...
          order && (
            <div className="bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-800/80 rounded-2xl p-5 text-left text-sm space-y-3.5 max-w-md mx-auto">
              ...
              <div className="space-y-1">
                <span className="text-gray-500 dark:text-gray-500 block font-semibold text-xxs uppercase tracking-wider">
                  Ship To
                </span>
        ...
        <div className="pt-4 grid gap-3 sm:grid-cols-2">
          <Link
            to="/orders"
            className="flex items-center justify-center rounded-xl border border-gray-200 hover:border-gray-300 dark:border-gray-700 dark:hover:border-gray-600 bg-white dark:bg-gray-800 px-5 py-3 text-sm font-semibold text-gray-700 dark:text-gray-300 hover:text-gray-900 transition-all"
          >
            View My Orders
          </Link>
          <Link
